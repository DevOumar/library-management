...
{% block pageTitle %} Cycles{% endblock %}
{% block addcss %}
<!-- DataTables -->
...
<ol class="breadcrumb">
    ...
    <li><i class="fa fa-angle-right"></i> cycle</li>
</ol>
{% endblock %}
    ...
    <div class="col-xl-4">
        <div class="card ">
            <div class="card-header bg-primary">
                ...
                <a href="{{url('cycle')}}" class="badge badge-info pull-right">Recharger</a>
            </div> 
            <div class="card-body">
                <form method="POST" {% if cycle is defined %} action="{{url('cycle/index/'~cycle.id)}}" {% else %} action="{{url('cycle/new')}}" {% endif %}>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback">
                                <label class="control-label">Nom du cycle</label>
                                {{form.render("libelle")}}
        ...
        <div class="col-xl-8">
           <div class="card ">
            ...
            <div class="card-header bg-primary">
               <h4 class="text-white m-b-0">Liste des cycles({{cycles |length}})</h4>
           </div>
           <div class="card-body">
               <hr />
               <div class="table-responsive">
                ...
                <tbody>
                    {% for k,cycle in cycles %}
                    <tr>
                        <td>{{k+1}}</td>
                        <td>{{cycle.libelle |upper}}</td>
                        <td>{{date('d/m/Y \à H:i',strtotime(cycle.create_date))}}</td>
                    <td>
                        <a href="{{url('cycle/index/'~cycle.id)}}"><i class="fa fa-edit"></i></a>
                        <a href="#" class="supelm" data-id = {{cycle.id}}><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                {% endfor %}
            </tbody>
